...
class SetCriterion(nn.Module):
    ...
    def loss_masks(self, outputs, targets, indices, num_boxes):
        ...
        #print(target_point_mask.shape, pred_segment_mask.shape, "target_point_mask.shape, pred_segment_mask.shape")
    ...
    def loss_instance_masks(self, outputs, targets, indices, num_boxes):
        ...
        if False: 
            ...
            for t, (_, i) in zip(targets, indices): 
                print(t['instance_masks'].shape, i)
            maskaskd = torch.cat(empty_list, dim=0)
            print(maskaskd)
